...
for i in range(1): # odreže stran vse do konca prve tabele, ker hočem drugo
...
tabela = tabela[2:-1] # zadnja vrstica je prazna, prvi dve tudi
print(tabela)


# shrani v csv
with open("skupno_stevilo_medalj.csv", "w", newline="", encoding='utf-8') as f:
    writer = csv.writer(f)
